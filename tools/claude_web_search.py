        ...
        try:
            response = responses(
                ...
                input=[
                    ...
                    {
                        "role": "user",
                        "content": "Please find an answer to the following queries: "
                        + ", ".join(self.queries)
                        + ". Use the following links if provided: "
                        + ", ".join(self.links)
                        if self.links
                        else "",
                    },
...
if __name__ == "__main__":
    ...
    tool = ClaudeWebSearch(
        queries=[
            "What is the latest version of the agency-swarm framework?",
            "How does fast API integration work in agency-swarm? Provide a full code example.",
        ],
        links=[
            "https://platform.openai.com/docs/api-reference/files/create",
            "https://agency-swarm.ai/llms.txt",
        ],
    )
    print(tool.run())
