...
class EmailTool(LifeTool):
    ...
    def fetch_recent_threads(self, limit: int = 20, query: str = 'in:inbox') -> ToolResult:
        ...
        # Group by Thread ID to avoid duplicates (messages list contains messages, not threads directly sometimes)
        # Actually messages.list returns list of messages with threadId.
