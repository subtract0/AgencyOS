...
class MasterOrchestrator:
    ...
    def orchestrate_epic4_2(self):
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "meta_learning/statistical_analysis.py"
            ],
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "meta_learning/proposal_generator_v2.py"
            ],
            dependencies=[
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "tests/meta_learning/test_statistical_analysis.py"
            ],
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "tests/meta_learning/test_proposal_generator_v2.py"
            ],
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "docs/proposal_generator_guide.md"
            ],
            dependencies=["epic4.2-code-proposal-generator"],
            priority=3
        ))
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "demos/proposal_workflow_demo.py"
            ],
            dependencies=["epic4.2-code-proposal-generator"],
            priority=2
        ))
    ...
    def orchestrate_medi_pack_v1(self):
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "dspy_agents/scout_fleet.py",
                "dspy_agents/__init__.py"
            ],
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "dspy_agents/context_consolidator.py"
            ],
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "dspy_agents/planner_phase.py"
            ],
            dependencies=[
                "medi-v1-spec-planner-phase",
                "medi-v1-code-context-consolidator"
            ],
            priority=7
        ))
        ...
        tasks.append(Task(
            ...
            files_to_modify=[
                "dspy_agents/scout_plan_build_orchestrator.py"
            ],
            dependencies=[
                "medi-v1-code-planner-phase",
                "medi-v1-code-builder-phase"
            ],
            priority=5
        ))
...
After running, start your autonomous agents in separate terminals.
    ...
    parser.add_argument(
        "--clear",
        action="store_true",
        help="Clear existing queue before adding tasks"
    )
