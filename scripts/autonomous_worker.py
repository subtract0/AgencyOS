...
class AutonomousWorker:
    ...
    def _execute_task(self, task: Task) -> bool:
        ...
        try:
            # Create worktree
            print(f"📁 Creating isolated worktree...")
            ...
            print(f"📝 Mission file created: autonomous_mission.md")
            print(f"🚀 Executing task via Claude Code Agent...\n")
            ...
            print(f"🗑️  Cleaning up worktree...")
            try:
...
"""
            ...
            print(f"⏱️  Task execution timed out (30 minutes)")
            return False
        except Exception as e:
