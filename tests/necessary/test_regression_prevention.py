...
class TestToolListConsistency:
    ...
    def test_expected_tools_present(self):
        ...
        with (
            patch("agencyos_agent.agencyos_agent.Agent") as mock_agent,
            patch("agencyos_agent.agencyos_agent.get_model_instance") as mock_model,
        ):
            mock_model.return_value = "gpt-5-mini"

            create_agencyos_agent(model="gpt-5-mini")
    ...
    def test_tool_list_not_empty(self):
        ...
        with (
            ...
            for effort in ["low", "medium", "high"]:
                create_agencyos_agent(model="gpt-5-mini", reasoning_effort=effort)
