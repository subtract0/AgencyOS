...
class TestLearningDashboard:
    ...
    def test_generate_comprehensive_report_with_error(self, learning_dashboard):
        ...
        with patch.object(
            learning_dashboard, "_collect_all_metrics", side_effect=Exception("Test error")
        ):
            result = learning_dashboard.generate_comprehensive_report()
    ...
    def test_collect_learning_progression_metrics(self, learning_dashboard):
        ...
        recent_time = datetime.now().isoformat()
        mock_memories = [
            {"content": {"type": "error_resolution", "confidence": 0.8}, "timestamp": recent_time},
            {"content": {"type": "optimization", "confidence": 0.9}, "timestamp": recent_time},
            {"content": "pattern learning applied", "timestamp": recent_time},
        ]
    ...
    def test_collect_performance_metrics(self, learning_dashboard):
        ...
        learning_dashboard.agent_context.get_session_memories.return_value = [
            "mem1",
            "mem2",
            "mem3",
        ]
    ...
    def test_calculate_metric_trend_with_history(self, learning_dashboard):
        ...
        learning_dashboard.metrics_history = [
            {"metrics": {"test_metric": {"value": 80.0}}},
            {"metrics": {"test_metric": {"value": 85.0}}},
    ...
    def test_is_recent_memory(self, learning_dashboard):
        ...
        # Old memory
        old_memory = {"timestamp": (datetime.now() - timedelta(hours=2)).isoformat()}
        ...
        invalid_timestamp_memory = {"timestamp": "invalid-timestamp"}
    ...
    def test_calculate_trends(self, learning_dashboard):
        ...
        metrics = {
            "embedding_coverage": LearningMetric(
                "Coverage", 80.0, "percent", "up", "desc", "timestamp"
            ),
            "total_memories": LearningMetric("Memories", 100.0, "count", "up", "desc", "timestamp"),
            "pattern_success_rate": LearningMetric(
                "Success", 75.0, "percent", "down", "desc", "timestamp"
            ),
            "pattern_application_rate": LearningMetric(
                "Apps", 5.0, "per_week", "stable", "desc", "timestamp"
            ),
            "learning_accumulation_rate": LearningMetric(
                "Learning", 10.0, "per_month", "up", "desc", "timestamp"
            ),
        }
    ...
    def test_generate_learning_insights(self, learning_dashboard):
        ...
        metrics = {
            "embedding_coverage": LearningMetric(
                "Coverage", 85.0, "percent", "up", "desc", "timestamp"
            ),
            "pattern_success_rate": LearningMetric(
                "Success", 90.0, "percent", "up", "desc", "timestamp"
            ),
            "pattern_application_rate": LearningMetric(
                "Apps", 10.0, "per_week", "up", "desc", "timestamp"
            ),
            "learning_diversity": LearningMetric(
                "Diversity", 8.0, "types", "up", "desc", "timestamp"
            ),
        }

        trends = {"vector_store": "improving", "pattern_application": "stable"}
    ...
    def test_calculate_system_health(self, learning_dashboard):
        ...
        metrics = {
            ...
            "pattern_success_rate": LearningMetric(
                "Success", 85.0, "percent", "up", "desc", "timestamp"
            ),
            "learning_accumulation_rate": LearningMetric(
                "Learning", 5.0, "per_month", "up", "desc", "timestamp"
            ),
        }

        alerts = [LearningAlert("warning", "Test warning", "test_metric", 50.0, 40.0, "timestamp")]
    ...
    def test_generate_improvement_recommendations(self, learning_dashboard):
        ...
        metrics = {
            "embedding_coverage": LearningMetric(
                "Coverage", 30.0, "percent", "down", "desc", "timestamp"
            ),
            "pattern_application_rate": LearningMetric(
                "Apps", 1.0, "per_week", "down", "desc", "timestamp"
            ),
        }
    ...
    def test_get_alert_resolution_actions(self, learning_dashboard):
        ...
        embedding_alert = LearningAlert(
            "error", "Embedding down", "embedding_status", 1.0, 0.0, "timestamp"
        )
        pattern_alert = LearningAlert(
            "warning", "Low success", "pattern_success_rate", 60.0, 40.0, "timestamp"
        )
    ...
    def test_create_executive_summary(self, learning_dashboard):
        ...
        health_score = {"score": 75.0, "status": "good"}
    ...
    def test_save_metrics_snapshot_error(self, learning_dashboard):
        ...
        with patch.object(
            learning_dashboard, "_collect_all_metrics", side_effect=Exception("Snapshot error")
        ):
            result = learning_dashboard.save_metrics_snapshot()
...
class TestLearningDashboardIntegration:
    ...
    def comprehensive_mock_data(self):
        ...
        return {
            ...
            "pattern_memories": [
                {
                    "content": "pattern applied successfully",
                    "timestamp": datetime.now().isoformat(),
                },
                {
                    "content": "pattern resolved issue effectively",
                    "timestamp": datetime.now().isoformat(),
                },
                {
                    "content": "pattern failed to work properly",
                    "timestamp": datetime.now().isoformat(),
                },
            ],
            "learning_memories": [
                {
                    "content": {"type": "error_resolution", "confidence": 0.9},
                    "timestamp": datetime.now().isoformat(),
                },
                {
                    "content": {"type": "optimization", "confidence": 0.8},
                    "timestamp": datetime.now().isoformat(),
                },
                {
                    "content": {"learning_type": "pattern", "confidence": 0.7},
                    "timestamp": datetime.now().isoformat(),
                },
            ],
            "cross_session_memories": [
                {
                    "content": "cross-session pattern successful",
                    "timestamp": datetime.now().isoformat(),
                },
                {
                    "content": "historical pattern effective",
                    "timestamp": datetime.now().isoformat(),
                },
            ],
            "trigger_memories": [
    ...
    def test_full_report_generation_integration(
        self, mock_agent_context, mock_vector_store, comprehensive_mock_data
    ):
        ...
        mock_agent_context.get_session_memories.return_value = comprehensive_mock_data[
            "session_memories"
        ]
