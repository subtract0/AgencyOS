...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    mark_parser = feedback_subparsers.add_parser(
        "mark",
        help="Mark task as misclassified"
    )
    ...
    list_parser = feedback_subparsers.add_parser(
        "list",
        help="List recent user feedback"
    )
    ...
    clear_parser = feedback_subparsers.add_parser(
        "clear",
        help="Clear user feedback for task"
    )
