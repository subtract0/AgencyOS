...
self._sub_agent_registry: Dict[str, Any] = {
    "CodeWriter": None,        # TODO: Import CodingAgent
...
def __init__(
    ...
    # Real agent registry
    self._sub_agent_registry: Dict[str, Any] = {
        "CodeWriter": CodingAgent(context=agent_context, cost_tracker=cost_tracker),
...
2. **Review** agent interfaces in `coding_agent/`, `test_generator_agent/`, etc.
