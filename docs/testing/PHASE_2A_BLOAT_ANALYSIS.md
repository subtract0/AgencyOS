...
- **coding_agent** (2 files):
  - `/Users/am/Code/Agency/tests/test_coding_agent.py`
  - `/Users/am/Code/Agency/tests/test_coding_agent_fixed.py`
...
5. **Consolidate Duplicates**: Review 10 duplicate test groups
   - Merge test_coding_agent_fixed.py → test_coding_agent.py
