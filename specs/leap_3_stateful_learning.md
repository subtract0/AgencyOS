...
#### Persona 1: AgencyCodeAgent (Skill-Accumulating Developer)
...
```
1. AgencyCodeAgent receives bug: NoneType error in shared/agent_context.py:145
...
```
1. AgencyCodeAgent receives bug: NoneType error in tools/bash.py:89
...
### Agent Integration
- **AgencyCodeAgent**: Primary consumer of adaptive routing (60% of tasks)
...
- **Implementation Agents**: AgencyCodeAgent, PlannerAgent, TestGenerator
