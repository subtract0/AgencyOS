...
ASSERTION_FIXES = {
    ...
    ("'Proactively triggered periodically' in", "chief_architect"): "'PROACTIVE strategic oversight' in",
    ...
    ("'RunArchitectureLoop tool' in", "chief_architect"): "'RunArchitectureLoop' in description.lower() or 'architecture' in",
    ("'memory patterns' in", "chief_architect"): "'strategic' in",
    ("'Q(T) scores' in", "chief_architect"): "'performance' in description.lower() or 'strategic' in",
