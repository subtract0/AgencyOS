...
class ImplementationConfig(BaseModel):
    ...
    features: dict[str, list[str]] = Field(
        default_factory=dict, description="Feature lists per implementation"
    )
...
class AgentLoader:
    ...
    def _load_dspy_agent(
        self, dspy_path: str, markdown_spec: str, frontmatter: AgentFrontmatter
    ) -> Any:
        """
    ...
    def _load_traditional_agent(
        self, traditional_path: str, markdown_spec: str, frontmatter: AgentFrontmatter
    ) -> Any:
        """
    ...
    def load_agent_from_frontmatter(
        ...
        markdown_body: str,
        force_implementation: Literal["dspy", "traditional"] | None = None,
    ) -> Any:
        """
            ...
            if impl_type == "dspy" and dspy_available:
                try:
                    agent = self._load_dspy_agent(
                        frontmatter.implementation.dspy, markdown_body, frontmatter
                    )
                except Exception as e:
                    ...
                    agent = self._load_traditional_agent(
                        frontmatter.implementation.traditional, markdown_body, frontmatter
                    )
    ...
    def load_agent(
        self, agent_path: str, force_implementation: Literal["dspy", "traditional"] | None = None
    ) -> Any:
        """
        ...
        return self.load_agent_from_frontmatter(frontmatter, markdown_body, force_implementation)
