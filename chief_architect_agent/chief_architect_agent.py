...
from shared.agent_utils import create_model_settings, get_model_instance, select_instructions_file
...
from tools import LS, Bash, ContextMessageHandoff, Edit, Glob, Grep, Read, TodoWrite, Write
...
def create_chief_architect_agent(
