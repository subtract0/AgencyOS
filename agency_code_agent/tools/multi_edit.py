...
class EditOperation(BaseModel):
    ...
    replace_all: Optional[bool] = Field(False, description="Replace all occurences of old_string (default false).")
...
class MultiEdit(BaseTool):
    ...
    edits: List[EditOperation] = Field(..., min_items=1, description="Array of edit operations to perform sequentially on the file")
...
'''
    ...
    new_file_edits = [
        EditOperation(old_string="", new_string="# New File\\nThis is a new file.\\nLine 2."),
