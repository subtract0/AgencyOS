...
class NotebookRead(BaseTool):
    ...
    notebook_path: str = Field(..., description="The absolute path to the Jupyter notebook file to read (must be absolute, not relative)")
    cell_id: Optional[str] = Field(None, description="The ID of a specific cell to read. If not provided, all cells will be read.")
