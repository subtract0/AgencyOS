...
1. **[CodingAgent](../../coding_agent/CLAUDE.md)**
...
**Implement a feature:**
- Has spec/plan? → [CodingAgent](../../coding_agent/CLAUDE.md)
...
- Write tests manually (TDD)? → [CodingAgent](../../coding_agent/CLAUDE.md)
...
```
Agency/
├── coding_agent/CLAUDE.md          (395 lines, 12KB)
